...
channel_stats = youtube_channel_stats.get_channel_statistics(API_KEY, "[REDACTED_CHANNEL_ID]")
lailala_stats = youtube_channel_stats.get_channel_statistics(API_KEY, [REDACTED]_CHANNEL_ID)
