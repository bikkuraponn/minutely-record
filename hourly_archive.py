...
def archive_if_due(
    turso_client, now_utc: datetime, video_stats: dict, channel_stats: dict, lailala_stats: dict,
) -> bool:
    ...
    record = {
        ...
        "lailala_topic_view_count": lailala_stats["total_views"],
        "lailala_topic_like_count": lailala_stats["total_likes"],
